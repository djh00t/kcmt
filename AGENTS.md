...
- Python 3.12, Rust 1.78 workspace + Python `argparse`, `pytest`, `uv`; Rust `clap`, `serde`, (003-bring-rust-cli)
- Local filesystem only (`~/.config/kcmt`, repo-local git working tree, (003-bring-rust-cli)
