...
- [ ] T010 [P] Establish contract/parity test harness for compatibility-critical behavior
- [ ] T011 [P] Establish baseline corpus and performance measurement harness

**Checkpoint**: Foundation ready - user story implementation can now begin in parallel
only after constitution gates are explicitly satisfied in plan.md
...
- Include explicit tasks for compatibility, performance baseline, and secret-safe
  error handling when in scope
