...
| NFR-005 | Local macOS baseline probes executed; cross-platform matrix automation added in `.github/workflows/rust-parity-matrix.yml` | IN PROGRESS (CI execution pending) |
...
| SC-003 workflow parity | Python alias/help/status probes passed locally | Rust parity probes pending CI matrix run | IN PROGRESS |
